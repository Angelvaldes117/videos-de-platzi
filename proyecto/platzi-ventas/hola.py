...
# Guardar datos de clientes en un archivo JSON
def save_clients():
    with open('clients.json', 'w') as file:
        json.dump(clients, file, indent=4)

# Inicialización de clientes desde el archivo
...
def _print_welcome():
    ...
    print('[U] Actualizar cliente')  # Actualizar cliente
    print('[D] Borrar cliente')  # Borrar cliente
    print('[S] Buscar cliente')  # Buscar cliente
    print('[L] Listar clientes')  # Listar clientes
    print('[E] Salir')  # Salir
