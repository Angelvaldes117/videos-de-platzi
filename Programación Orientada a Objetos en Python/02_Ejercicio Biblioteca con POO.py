...
class Book:
    def __init__(self, title, author):
        self.title = title # Creamos nuestro contructor
        self.author = author
        self.available = True
...
class User:
    def __init__(self, name, user_id): #creamos nuestro segundo contructor
        self.name = name
        self.user_id = user_id
        self.borrowed_books = [] #libros prestado 
...
class Library:
    def __init__(self):
        self.books = []  #creamos nuestro 3 contructor  
        self.users = []
